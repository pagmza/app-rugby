...
# --- FUNCIÓN DE VISUALIZACIÓN (CORREGIDA SIN INDENTACIÓN) ---
def renderizar_tarjetas(metricas):
    """
    Genera tarjetas HTML eliminando espacios para evitar que Streamlit
    las confunda con bloques de código.
    """
    
    # CSS COMPACTO Y SIN INDENTACIÓN
    estilo = """
<style>
.flex-wrapper {
    display: flex;
...
"""
    ...
    # CONSTRUCCIÓN DEL HTML (EN UNA SOLA LÍNEA PARA EVITAR ERRORES)
    cards_html = ""
    for m in metricas:
        # Lógica simple
        ...
        # Concatenamos SIN saltos de línea ni espacios extraños
...
def limpiar_datos_asistencia(df):
    ...
    # Ajuste automático de nombres de columnas
...
def mostrar_dashboard(df_jugadores):
    st.title("📊 Tablero de Comando V3.0")
